...
public class SwiftMidFlutterPlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "mid_flutter", binaryMessenger: registrar.messenger())
        let instance = SwiftMidFlutterPlugin()
